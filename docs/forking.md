...
| `brand_mark` | **(v1 only)** Single character in the v1 brand box. v2 uses a fixed baseball-diamond mark (a team-neutral white infield on `--team-primary`) and does **not** read this field. | Usually first letter of team |
